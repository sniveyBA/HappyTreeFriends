Public Class frmLevel1
    ...
    Dim timerState As Boolean = False
    ...
    Public Sub btn1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn1.Click
        ...
        'Close the application once 20 questions have been asked
        If arrCount = 20 Then
...
Start:
    ...
    Private Sub tmr60_Tick(sender As Object, e As EventArgs) Handles tmr60.Tick
